 ...
 */
final class Version20241107182405 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE assignment_checker (assignment_id INT NOT NULL, checker_id INT NOT NULL, INDEX IDX_3AE9422BD19302F8 (assignment_id), INDEX IDX_3AE9422B77637F8F (checker_id), PRIMARY KEY(assignment_id, checker_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
