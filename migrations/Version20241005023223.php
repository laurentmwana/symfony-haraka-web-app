 ...
 */
final class Version20241005023223 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD student_id INT DEFAULT NULL, ADD checker_id INT DEFAULT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8D93D64977637F8F ON user (checker_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_8D93D64977637F8F ON user');
        $this->addSql('ALTER TABLE user DROP student_id, DROP checker_id');
    }
}
